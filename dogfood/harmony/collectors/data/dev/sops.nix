          ...
          options =
            ...
            in
            {
              creation_rules = lib.mkOption {
                type = lib.types.listOf (lib.types.submodule { options = creationRuleOptions; });
                default = [ ];
                  ...
                  lib.types.submodule {
                    options = {
                      ...
                      recreation_rule = lib.mkOption {
                        type = lib.types.nullOr (lib.types.submodule { options = creationRuleOptions; });
                        default = null;
                        description = "Recreation rule (same structure as creation_rules items).";
                      };
